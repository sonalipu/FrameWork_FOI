...
public class ClickRole {
	...
	{
		this.driver=driver;
		driver.findElement(By.xpath("//*[@id=\"#kt_aside_menu\"]/div[4]/div/div/div[2]/a/span[3]")).click();
	}
	
	public void AddNewRoles (WebDriver driver,String userrole) throws InterruptedException
	{
		this.driver=driver;
	...
	public void EditRole (WebDriver driver,String userrole) throws InterruptedException
	{
	    ...
	    public void DeleteRoles (WebDriver driver,String userrole) throws InterruptedException
		{
			...
			new WebDriverWait(driver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(deltebtn));
			//Thread.sleep(10000);  
			deltebtn.click();
